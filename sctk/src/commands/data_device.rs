...
pub fn start_internal_drag<Message>(
    origin_id: iced_core::window::Id,
    icon_id: Option<iced_core::window::Id>,
) -> Task<Message> {
...
pub fn accept_mime_type<Message>(mime_type: Option<String>) -> Task<Message> {
    Task::effect(Action::PlatformSpecific(
        platform_specific::Action::Wayland(wayland::Action::DataDevice(
...
pub fn request_dnd_data<Message>(mime_type: String) -> Task<Message> {
    Task::effect(Action::PlatformSpecific(
        platform_specific::Action::Wayland(wayland::Action::DataDevice(
...
pub fn finish_dnd<Message>() -> Task<Message> {
    Task::effect(Action::PlatformSpecific(
        platform_specific::Action::Wayland(wayland::Action::DataDevice(
...
pub fn cancel_dnd<Message>() -> Task<Message> {
    Task::effect(Action::PlatformSpecific(
        platform_specific::Action::Wayland(wayland::Action::DataDevice(
...
pub fn action<Message>(action: ActionInner) -> Task<Message> {
    Task::effect(Action::PlatformSpecific(
        platform_specific::Action::Wayland(wayland::Action::DataDevice(
            action.into(),
        )),
