...
pub struct SctkWindow {
    pub(crate) id: iced_core::window::Id,
...
pub struct Dnd {
    pub(crate) origin_id: iced_core::window::Id,
    pub(crate) origin: WlSurface,
    pub(crate) source: Option<(DragSource, Box<dyn DataFromMimeType>)>,
    pub(crate) icon_surface: Option<(WlSurface, iced_core::window::Id)>,
    pub(crate) pending_requests:
        Vec<platform_specific::wayland::data_device::Action>,
...
pub struct SctkState<T> {
    ...
    pub(crate) dnd_source: Option<Dnd>,
    ...
    T: 'static + Debug,
{
    pub fn get_popup(
        ...
        (iced_core::window::Id, WlSurface, WlSurface, WlSurface),
        PopupCreationError,
    > {
