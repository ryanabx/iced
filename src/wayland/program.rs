...
use iced_sctk::application::{self, DefaultStyle, Appearance};

use crate::theme::{self, Theme};
use crate::{
    wayland::Application, Command, Element, Font, Error, Settings, Subscription,
};
...
impl<P: Definition> Program<P> {
        ...
        Self: 'static,
    {
        ...
        Instance::run(Settings {
            flags: raw,
            id: settings.id,
            initial_surface: settings.initial_surface,
